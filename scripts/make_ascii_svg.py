...
def main():
    ...
    # IMPORTANT FIX
    #
    # FIND ACTUAL VISIBLE PORTRAIT
    #
    # Do NOT center the whole ASCII canvas.
    # Center the actual non-space person.
    # ========================================================
    ...
    # ========================================================
    # CENTER ASCII CANVAS IN TERMINAL
    # ========================================================
